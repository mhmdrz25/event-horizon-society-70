...
const FileUploadSection: React.FC<FileUploadSectionProps> = ({ submissionId }) => {
  const { user } = useAuth();
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <input
            ...
            className="hidden"
            accept=".pdf,.zip,.doc,.docx,.txt,.jpg,.jpeg,.png,.gif"
          />
          <Button
          ...
          <p className="text-xs text-muted-foreground text-center">
            فرمت‌های مجاز: PDF، ZIP، Word، تصویر، متن (حداکثر ۱۰ مگابایت)
          </p>
        </div>
